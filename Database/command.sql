...
CREATE TABLE `command` (
  ...
  `help` longtext CHARACTER SET utf8,
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_german1_ci ROW_FORMAT=FIXED COMMENT='Chat System';
...
INSERT INTO `command` VALUES ('bank', '217', 'Syntax: .bank\r\n\r\nShow your bank inventory.');
...
INSERT INTO `command` VALUES ('event activelist', '217', 'Syntax: .event activelist\r\nShow list of currently active events.');
...
INSERT INTO `command` VALUES ('gps', '217', 'Syntax: .gps [$name|$shift-link]\r\n\r\nDisplay the position information for a selected character or creature (also if player name $name provided then for named player, or if creature/gameobject shift-link provided then pointed creature/gameobject if it loaded). Position information includes X, Y, Z, and orientation, map Id and zone Id');
